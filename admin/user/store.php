<?php
/**
 * Point d'entrée pour la création d'un utilisateur
 */
...
$_SESSION['redirect_mappings'] = [
    '/tutoring/admin/users/create.php' => '/tutoring/views/admin/user/create.php',
...
// Traiter la création de l'utilisateur
