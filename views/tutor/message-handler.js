/**
 * Gestionnaire spécifique pour les messages des tuteurs
 * Version unifiée qui fonctionne avec le format d'interface commun
 */
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('Initialisation du gestionnaire de messages pour les tuteurs (version unifiée)');
    ...
    if (deleteButton) {
        deleteButton.addEventListener('click', function() {
            ...
            console.log("Carte active:", activeCard);
            ...
            if (activeCard) {
                ...
                if (conversationId) {
                    ...
                    const conversationIdInput = document.getElementById('conversation_id_to_delete');
                    console.log("Input ID de conversation:", conversationIdInput);
                    
                    if (conversationIdInput) {
                        conversationIdInput.value = conversationId;
                        console.log("Valeur définie:", conversationIdInput.value);
                        
                        // Log le formulaire complet
                        console.log("Formulaire de suppression:", document.getElementById('deleteMessageForm'));
                        console.log("Contenu du formulaire:", document.getElementById('deleteMessageForm').innerHTML);
                        
                        // Afficher le modal de confirmation
                        const deleteModalElement = document.getElementById('deleteMessageModal');
                        console.log("Modal de suppression:", deleteModalElement);
                        ...
                        console.error("L'élément input pour l'ID de conversation est introuvable");
                    }
                } else {
                    console.error("ID de conversation introuvable pour la carte active");
                }
            } else {
    ...
    if (replyForm) {
        replyForm.addEventListener('submit', function(e) {
            ...
            fetch('/tutoring/views/tutor/messages.php', {
                method: 'POST',
                body: formData
            })
            .then(response => {
