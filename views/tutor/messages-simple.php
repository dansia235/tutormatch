<?php
/**
 * Vue simplifiée pour la messagerie des tuteurs
 * Permet d'afficher et d'envoyer des messages
 * Version sans la fonctionnalité de suppression qui pose problème
 */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['send_message'])) {
        ...
        if (isset($_POST['receiver_type']) && $_POST['receiver_type'] === 'student') {
        ...
        header('Location: /tutoring/views/tutor/messages-simple.php');
        exit;
