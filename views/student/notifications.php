<?php
/**
 * Vue pour la liste des notifications de l'étudiant
 */
            ...
            <div class="list-group list-group-flush">
                <?php foreach ($notifications as $notification): ?>
                    ...
                    if ($notification['related_type'] && $notification['related_id']) {
                        ...
                        switch ($relatedType) {
                            case 'assignment':
                                $url = "/tutoring/views/student/assignment.php?id=$relatedId";
                                break;
                            case 'internship':
                                $url = "/tutoring/views/student/internship.php?id=$relatedId";
                                break;
                            case 'document':
                                $url = "/tutoring/views/student/documents.php?id=$relatedId";
                                break;
                            case 'meeting':
                                $url = "/tutoring/views/student/meetings.php?id=$relatedId";
                                break;
                            case 'message':
                                $url = "/tutoring/views/student/messages.php?conversation=$relatedId";
                                break;
                            case 'evaluation':
                                $url = "/tutoring/views/student/evaluations.php?id=$relatedId";
                                break;
                            case 'tutor':
                                $url = "/tutoring/views/student/tutor.php?id=$relatedId";
                                break;
                        }
                    }
