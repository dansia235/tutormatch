<?php
/**
 * Vue pour modifier un enseignant (tuteur)
 */

// Initialiser les variables
$pageTitle = 'Modifier un tuteur';
$currentPage = 'tutors';
...
$preferences = $teacherModel->getPreferences($teacher['id']);

// Organiser les préférences par type et valeur
$organizedPreferences = [];
foreach ($preferences as $preference) {
    $type = $preference['preference_type'];
    $value = $preference['preference_value'];
    $priority = $preference['priority_value'];
    
    if (!isset($organizedPreferences[$type])) {
        $organizedPreferences[$type] = [];
    }
    
    $organizedPreferences[$type][$value] = $priority;
}
...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h2 mb-0">
                <i class="bi bi-person-badge me-2"></i>Modifier un tuteur
            </h1>
        ...
        <div class="btn-group" role="group">
            <a href="/tutoring/views/admin/teachers/show.php?id=<?php echo $teacher['id']; ?>" class="btn btn-outline-primary">
    ...
    <!-- Formulaire de modification du tuteur -->
    <div class="card">
        <div class="card-header">
            <h5 class="card-title mb-0">Informations du tuteur</h5>
        </div>
        <div class="card-body">
            <form action="/tutoring/views/admin/teachers/update.php" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="mb-2">
                            <img src="<?php echo h($teacher['profile_image']); ?>" alt="Profile" class="rounded" width="100">
                        </div>
                        <?php endif; ?>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" class="form-control" id="max_students" name="max_students" value="<?php echo h($formData['max_students']); ?>" min="1" max="20" required>
                    </div>
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                <div class="preferences-container" id="domain-preferences">
                                    <?php 
                                    // Afficher les préférences existantes
                                    if (isset($organizedPreferences['DOMAIN'])) {
                                        $i = 0;
                                        foreach ($organizedPreferences['DOMAIN'] as $value => $priority):
                                    ?>
                                    <div class="row mb-2 preference-item">
                                        <div class="col-8">
                                            <select class="form-select" name="preferences[DOMAIN][<?php echo $i; ?>]">
                                                <option value="">-- Sélectionner un domaine --</option>
                                                <?php foreach ($domains as $domain): ?>
                                                <option value="<?php echo h($domain); ?>" <?php echo ($value === $domain) ? 'selected' : ''; ?>>
                                                    <?php echo h($domain); ?>
                                                </option>
                                                <?php endforeach; ?>
                                            </select>
                                        ...
                                        <div class="col-3">
                                            <select class="form-select" name="preferences[DOMAIN][priority][<?php echo $i; ?>]">
                                                <?php for ($j = 1; $j <= 10; $j++): ?>
                                                <option value="<?php echo $j; ?>" <?php echo $j == $priority ? 'selected' : ''; ?>><?php echo $j; ?>/10</option>
                                                <?php endfor; ?>
                                            </select>
                                        </div>
                                        <div class="col-1">
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                <div class="preferences-container" id="department-preferences">
                                    <?php 
                                    // Afficher les préférences existantes
                                    if (isset($organizedPreferences['DEPARTMENT'])) {
                                        $i = 0;
                                        foreach ($organizedPreferences['DEPARTMENT'] as $value => $priority):
                                    ?>
                                    <div class="row mb-2 preference-item">
                                        <div class="col-8">
                                            <select class="form-select" name="preferences[DEPARTMENT][<?php echo $i; ?>]">
                                                <option value="">-- Sélectionner un département --</option>
                                                <?php foreach ($departments as $department): ?>
                                                <option value="<?php echo h($department); ?>" <?php echo ($value === $department) ? 'selected' : ''; ?>>
                                                    <?php echo h($department); ?>
                                                </option>
                                                <?php endforeach; ?>
                                            </select>
                                        ...
                                        <div class="col-3">
                                            <select class="form-select" name="preferences[DEPARTMENT][priority][<?php echo $i; ?>]">
                                                <?php for ($j = 1; $j <= 10; $j++): ?>
                                                <option value="<?php echo $j; ?>" <?php echo $j == $priority ? 'selected' : ''; ?>><?php echo $j; ?>/10</option>
                                                <?php endfor; ?>
                                            </select>
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                <div class="preferences-container" id="level-preferences">
                                    <?php 
                                    // Afficher les préférences existantes
                                    if (isset($organizedPreferences['LEVEL'])) {
                                        $i = 0;
                                        foreach ($organizedPreferences['LEVEL'] as $value => $priority):
                                    ?>
                                    <div class="row mb-2 preference-item">
                                        <div class="col-8">
                                            <select class="form-select" name="preferences[LEVEL][<?php echo $i; ?>]">
                                                <option value="">-- Sélectionner un niveau --</option>
                                                <?php foreach ($levels as $level): ?>
                                                <option value="<?php echo h($level); ?>" <?php echo ($value === $level) ? 'selected' : ''; ?>>
                                                    <?php echo h($level); ?>
                                                </option>
                                                <?php endforeach; ?>
                                            </select>
                                        ...
                                        <div class="col-3">
                                            <select class="form-select" name="preferences[LEVEL][priority][<?php echo $i; ?>]">
                                                <?php for ($j = 1; $j <= 10; $j++): ?>
                                                <option value="<?php echo $j; ?>" <?php echo $j == $priority ? 'selected' : ''; ?>><?php echo $j; ?>/10</option>
                                                <?php endfor; ?>
                                            </select>
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                <div class="preferences-container" id="program-preferences">
                                    <?php 
                                    // Afficher les préférences existantes
                                    if (isset($organizedPreferences['PROGRAM'])) {
                                        $i = 0;
                                        foreach ($organizedPreferences['PROGRAM'] as $value => $priority):
                                    ?>
                                    <div class="row mb-2 preference-item">
                                        <div class="col-8">
                                            <select class="form-select" name="preferences[PROGRAM][<?php echo $i; ?>]">
                                                <option value="">-- Sélectionner un programme --</option>
                                                <?php foreach ($programs as $program): ?>
                                                <option value="<?php echo h($program); ?>" <?php echo ($value === $program) ? 'selected' : ''; ?>>
                                                    <?php echo h($program); ?>
                                                </option>
                                                <?php endforeach; ?>
                                            </select>
                                        ...
                                        <div class="col-3">
                                            <select class="form-select" name="preferences[PROGRAM][priority][<?php echo $i; ?>]">
                                                <?php for ($j = 1; $j <= 10; $j++): ?>
                                                <option value="<?php echo $j; ?>" <?php echo $j == $priority ? 'selected' : ''; ?>><?php echo $j; ?>/10</option>
                                                <?php endfor; ?>
                                            </select>
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                <div class="preferences-container" id="company-preferences">
                                    <?php 
                                    // Afficher les préférences existantes
                                    if (isset($organizedPreferences['COMPANY'])) {
                                        $i = 0;
                                        foreach ($organizedPreferences['COMPANY'] as $value => $priority):
                                    ?>
                                    <div class="row mb-2 preference-item">
                                        <div class="col-8">
                                            <select class="form-select" name="preferences[COMPANY][<?php echo $i; ?>]">
                                                <option value="">-- Sélectionner une entreprise --</option>
                                                <?php foreach ($companies as $company): ?>
                                                <option value="<?php echo h($company['id']); ?>" <?php echo ($value == $company['id']) ? 'selected' : ''; ?>>
                                        ...
                                        <div class="col-3">
                                            <select class="form-select" name="preferences[COMPANY][priority][<?php echo $i; ?>]">
                                                <?php for ($j = 1; $j <= 10; $j++): ?>
                                                <option value="<?php echo $j; ?>" <?php echo $j == $priority ? 'selected' : ''; ?>><?php echo $j; ?>/10</option>
                                                <?php endfor; ?>
                                            </select>
                ...
                <div class="d-flex justify-content-between mt-4">
                    <a href="/tutoring/views/admin/tutors.php" class="btn btn-secondary">Annuler</a>
...
<script>
    ...
    // Add remove event listeners to existing preference items
