        ...
        <div class="card-body p-5">
            <form action="/tutoring/views/admin/assignments/generate-process.php" method="POST" class="space-y-6" data-controller="generation-form">
                ...
                <div class="flex justify-end space-x-3">
                    <a href="/tutoring/views/admin/assignments/index.php" class="inline-flex justify-center py-2 px-4 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">
                        Annuler
                    </a>
