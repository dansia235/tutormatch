...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        ...
        foreach ($categories as $key => $category):
            $count = isset($stats) && isset($stats[$key]) ? $stats[$key] : 0;
        ?>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-muted small"><?php echo h(truncate($document['description'], 50)); ?></div>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <?php echo h($document['first_name'] . ' ' . $document['last_name']); ?>
                            ...
                            <td>
                                ...
                                echo isset($visibilityLabels[$visibility]) ? $visibilityLabels[$visibility] : '<span class="badge bg-secondary">Inconnu</span>';
                                ?>
                            </td>
                            <td>
                                <div class="btn-group" role="group">
