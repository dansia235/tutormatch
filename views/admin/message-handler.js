/**
 * Gestionnaire spécifique pour les messages des administrateurs et coordinateurs
 */
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('Initialisation du gestionnaire de messages pour les administrateurs/coordinateurs');
    ...
    if (replyForm) {
        replyForm.addEventListener('submit', function(e) {
            ...
            fetch('/tutoring/views/admin/messages-new.php', {
                method: 'POST',
                body: formData
            })
            .then(response => {
