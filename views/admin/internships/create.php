<?php
/**
 * Vue pour créer un nouveau stage
 */

// Initialiser les variables
$pageTitle = 'Ajouter un stage';
...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h2 mb-0">
                <i class="bi bi-briefcase me-2"></i>Ajouter un stage
            </h1>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="/tutoring/views/admin/internships/store.php" method="POST" class="needs-validation" novalidate>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group">
                            <select class="form-select" id="company_id" name="company_id" required>
                                ...
                                <option value="<?php echo h($company['id']); ?>" <?php echo (isset($formData['company_id']) && $formData['company_id'] == $company['id']) ? 'selected' : ''; ?>>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select" id="domain" name="domain" required>
                            ...
                            <option value="<?php echo h($domain); ?>" <?php echo (isset($formData['domain']) && $formData['domain'] === $domain) ? 'selected' : ''; ?>>
                                <?php echo h($domain); ?>
                            </option>
                            <?php endforeach; ?>
                        </select>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select" id="status" name="status" required>
                            <option value="available" <?php echo (!isset($formData['status']) || $formData['status'] === 'available') ? 'selected' : ''; ?>>Disponible</option>
                            <option value="assigned" <?php echo (isset($formData['status']) && $formData['status'] === 'assigned') ? 'selected' : ''; ?>>Affecté</option>
                            <option value="completed" <?php echo (isset($formData['status']) && $formData['status'] === 'completed') ? 'selected' : ''; ?>>Terminé</option>
                            <option value="cancelled" <?php echo (isset($formData['status']) && $formData['status'] === 'cancelled') ? 'selected' : ''; ?>>Annulé</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select" id="work_mode" name="work_mode" required>
                            <option value="on_site" <?php echo (!isset($formData['work_mode']) || $formData['work_mode'] === 'on_site') ? 'selected' : ''; ?>>Sur site</option>
                            <option value="remote" <?php echo (isset($formData['work_mode']) && $formData['work_mode'] === 'remote') ? 'selected' : ''; ?>>À distance</option>
                            <option value="hybrid" <?php echo (isset($formData['work_mode']) && $formData['work_mode'] === 'hybrid') ? 'selected' : ''; ?>>Hybride</option>
                        </select>
                    </div>
                    <div class="col-md-6 mb-3">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <div class="skills-container mb-2" id="skills-container">
                            <?php if (isset($formData['skills']) && is_array($formData['skills'])): ?>
                                <?php foreach ($formData['skills'] as $index => $skill): ?>
                                    <?php if (!empty($skill)): ?>
                                    <div class="input-group mb-2 skill-item">
                                        <input type="text" class="form-control" name="skills[]" value="<?php echo h($skill); ?>" placeholder="Compétence">
