<?php
/**
 * Vue pour ajouter une nouvelle entreprise
 */
...
<div class="container-fluid mt-4">
    ...
    <!-- Titre de la page -->
    <h2 class="mb-4"><i class="bi bi-building-add me-2"></i>Ajouter une nouvelle entreprise</h2>
    ...
    <div class="card form-card mb-4">
        ...
        <div class="card-body">
            <form action="/tutoring/views/admin/companies/store.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        <div class="preview-avatar me-3" style="background-color: #3498db;">
                                            <?php echo isset($formData['name']) ? getInitials($formData['name']) : 'CO'; ?>
                                        </div>
                                    </div>
                                ...
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="active" name="active" value="1" <?php echo (isset($formData['active']) && $formData['active']) || !isset($formData['active']) ? 'checked' : ''; ?>>
                ...
                <div class="card-footer text-end">
                    <a href="/tutoring/views/admin/companies.php" class="btn btn-secondary me-2">Annuler</a>
                    <button type="submit" class="btn btn-primary">
                        <i class="bi bi-save me-2"></i>Enregistrer l'entreprise
                    </button>
                </div>
            </form>
        </div>
...
<script>
    ...
    document.getElementById('name').addEventListener('input', function(e) {
        ...
        if (avatar) {
            ...
            avatar.textContent = initials.toUpperCase() || 'CO';
        }
    });
