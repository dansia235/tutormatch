<?php
/**
 * Vue pour la messagerie des coordinateurs
...
// Vérifier que l'utilisateur est connecté et a le rôle coordinateur
...
if (!$user) {
    setFlashMessage('error', 'Profil coordinateur non trouvé');
    ...
    if (isset($_POST['send_message'])) {
        ...
        try {
            ...
            if ($messageId) {
                ...
                redirect('/tutoring/views/coordinator/messages.php');
            } else {
...
// Ajouter d'autres coordinateurs et admins
...
<script src="/tutoring/views/coordinator/message-handler.js"></script>
